...
if ($bg_video == 'yes') {
    ...
    $stream_source = $stream_host_website;
        ...
        if ($stream_host_website == 'youtube'){
            ...
            $stream_source = 'vimeo';
            $video_output .= '<iframe src="//player.vimeo.com/video/'.$stream_video_id.'?badge=0&amp;api=1" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
        }
        $video_output .= '</div>';
    }
}
