...
<form method="post" class="lost_reset_password">
	...
	<?php if( 'lost_password' == $args['form'] ) : ?>
        ...
        <p class="form-row form-row-first"><label for="user_login"><?php _e( 'Username or email', 'mk_framework' ); ?></label> <input class="input-text" type="text" name="user_login" id="user_login" /></p>
    ...
    <p class="form-row"><input type="submit" class="shop-flat-btn shop-skin-btn" name="wc_reset_password" value="<?php echo 'lost_password' == $args['form'] ? __( 'Reset Password', 'mk_framework' ) : __( 'Save', 'mk_framework' ); ?>" /></p>
